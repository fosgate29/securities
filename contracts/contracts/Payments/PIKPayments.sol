...
contract PIKPayments is Ownable {
    ...
    //To-Do: Condense interfaces. 
    SecurityTokenI public mintToken;
	...
	*/
    constructor(IERC20 _securityToken, SecurityTokenI _mintToken, address _issuer) public {
    ...
    */
    function allocatePayment(address[] _holders, uint256 _paymentPerShare) public onlyOwner {
        ...
        for (uint256 i = 0; i < _holders.length; i++){
            ...
            mintToken.mint(_holders[i], paymentOwed);
